...
updated: 2023-09-03 22:59
authors:
  - Edmund Leibert III
tags:
  - 🔴-academics/📚-educational-resources/name/leetcode
  - 🔴-academics/📚-educational-resources/source-format/internet/website
  - 🔴-academics/📚-educational-resources/name/🌐-leetcode/🔖-bookmark/🌐-leetcode/🌐-leetCode-▹-📋-table-of-contents/problems/1-two-sum
...
- Given the relatively small maximum size for `nums` (recall that one of the **constraints** for the problem is `2 <= nums.length <= 104`), we can safely use `std::unordered_map` instead to achieve a $O(1)$ worst case time complexity.
