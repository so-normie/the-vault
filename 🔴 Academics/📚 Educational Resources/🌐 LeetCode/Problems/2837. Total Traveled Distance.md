...
The {c1:`AVG()`} function returns the average value of a numeric column in SQL Server.
#🔴-academics/📚-educational-resources/discipline/computer-science/dbms/sql-server 


The {c1:`COUNT()`} function returns the number of rows that matches a specified criterion in SQL Server.
#🔴-academics/📚-educational-resources/discipline/computer-science/dbms/sql-server 


The {c1:`MAX()`} function returns the maximum value in a set of values in SQL Server. 
#🔴-academics/📚-educational-resources/discipline/computer-science/dbms/sql-server 
