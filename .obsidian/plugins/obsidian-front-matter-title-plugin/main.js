...
var AbstractBuilder = class {
  ...
  buildEnable() {
    ...
    return new import_obsidian7.Setting(this.context.getContainer()).setName(fragment).setDesc(this.options.desc).addButton((b) => {
  ...
  buildTemplates(el) {
    ...
    for (const type of ["main", "fallback"]) {
      ...
      const setting = new import_obsidian7.Setting(el).setName(t2(`template.${type}`)).setDesc(this.getDesc(type, tStorage.value())).addText((e) => {
        var _a;
...
var AliasBuilder = class extends AbstractBuilder {
  ...
  buildValidatorDropdown(el) {
    ...
    const s = new import_obsidian8.Setting(el).setName(t2("strategy"));
    this.validatorDropdown = new import_obsidian8.DropdownComponent(s.controlEl).addOptions({
  ...
  buildStrategyDropdown(el) {
    ...
    const s = new import_obsidian8.Setting(el).setName(t2("strategy"));
    this.strategyDropdown = new import_obsidian8.DropdownComponent(s.controlEl).addOptions({
...
var TemplatesBuilder = class extends AbstractBuilder2 {
  ...
  buildTemplate() {
    new import_obsidian9.Setting(this.container).setName(this.createDocFragment(t2("template.common.main.name"))).setDesc(t2("template.common.main.desc")).addText(
      (text) => {
        var _a;
  ...
  buildFallbackTemplate() {
    new import_obsidian9.Setting(this.container).setName(this.createDocFragment(t2("template.common.fallback.name"))).setDesc(t2("template.common.fallback.desc")).addText(
      (text) => {
        var _a;
...
var NoteLinkBuilder = class extends AbstractBuilder {
  ...
  buildStrategy(el) {
    new import_obsidian14.Setting(el).setName(t2("feature.noteLink.strategy.name")).setDesc(t2("feature.noteLink.strategy.desc")).addDropdown((e) => {
      var _a;
      e.addOptions({
  ...
  buildApproval(el) {
    new import_obsidian14.Setting(el).setName(t2("feature.noteLink.approval.name")).setDesc(t2("feature.noteLink.approval.desc")).addDropdown((e) => {
      e.addOptions({
...
var ExplorerBuilder = class extends AbstractBuilder {
  ...
  buildSort(el) {
    new import_obsidian15.Setting(el).setName(t2("feature.explorer.sort.name")).setDesc(t2("feature.explorer.sort.desc")).addToggle((e) => {
...
var PluginHelper = class {
  static compareVersion(left, operation, right) {
  ...
  static createDefaultSettings() {
    return {
      ...
      features: {
        ...
        ["starred" /* Starred */]: { enabled: false, templates: { main: "", fallback: "" } },
  ...
  reloadFeatures() {
    ...
    for (const [id3, state] of states) {
      try {
        ...
        new import_obsidian18.Notice(e);
      }
    }
  }
  registerCommands() {
